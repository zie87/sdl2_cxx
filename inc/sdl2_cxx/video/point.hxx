...
inline bool operator==(const sdl2::point& lhs, const sdl2::point& rhs) noexcept { return (lhs.x() == rhs.x()) && (lhs.y() == rhs.y()); }
inline bool operator!=(const sdl2::point& lhs, const sdl2::point& rhs) noexcept { return !(lhs == rhs); }
