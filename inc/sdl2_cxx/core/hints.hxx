...
namespace sdl2
{
  ...
  struct hint final 
  {
    ...
    static inline bool set(hint_type name, value_type value, priority priority) noexcept { return (SDL_SetHintWithPriority(to_sdl_type(name), value, static_cast<SDL_HintPriority>(priority)) == SDL_TRUE); }
